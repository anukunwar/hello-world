package day6;
	...
	public class ExcelReader {
		...
		public ExcelReader(String path) throws Exception
		{
			 ...
			 * 
			 */
			//System.out.println("ExcelReader Constructor Start");
			...
			fis.close();
		//	System.out.println("ExcelReader constructor Stop");
		}
		...
		public XSSFSheet setsheet(String sheetname)
		{
			 ...
			 */
			//System.out.println("setsheet method");
			XSSFSheet sheet = wb.getSheet(sheetname);
			return sheet;
			//System.out.println("setsheet method stop");
		}
		...
		public void saveexcel(String path) throws Exception
		{
			 ...
			 */
			FileOutputStream fout = new FileOutputStream(path);//it will create fos object which will write data to file at specified location.
			wb.write(fout);
			fout.close();
		}
